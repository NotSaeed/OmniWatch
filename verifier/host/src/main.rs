...
fn build_scenarios() -> Vec<Scenario> {
    vec![
        ...
        Scenario {
            ...
            telemetry: NetworkTelemetry {
                src_ip:             [185, 220, 101, 45],  // Tor exit node range
                dst_ip:             [192, 168,   1, 100],
                dst_port:           22,
                protocol:           6,                     // TCP
                flow_duration_us:   15_000_000,            // 15 s
                flow_bytes_s_milli: 8_500_000,             // 8.5 KB/s
                packet_count:       340,
                direction:          0,                     // inbound
                sourcetype:         1,                     // suricata (not sparse)
            },
        },
        ...
        Scenario {
            ...
            telemetry: NetworkTelemetry {
                src_ip:             [203,   0, 113, 42],  // TEST-NET-3 (RFC 5737)
                dst_ip:             [  8,   8,   8,  8],
                dst_port:           53,
                protocol:           17,                    // UDP
                flow_duration_us:   1_000_000,             // 1 s
                flow_bytes_s_milli: 2_500_000_000,         // 2.5 MB/s
                packet_count:       18_000,
                direction:          0,
                sourcetype:         1,                     // suricata
            },
        },
        ...
        Scenario {
            ...
            telemetry: NetworkTelemetry {
                ...
                dst_port:           443,
                protocol:           6,
                flow_duration_us:   50_000,                // 50 ms
                flow_bytes_s_milli: 200_000,               // 200 B/s
                packet_count:       1,
                direction:          0,
                sourcetype:         1,
            },
        ...
        Scenario {
            ...
            telemetry: NetworkTelemetry {
                src_ip:             [10,  0,  1,  25],    // internal host
                dst_ip:             [91, 108, 4, 167],    // Telegram IP range (known exfil vector)
                dst_port:           443,
                protocol:           6,
                flow_duration_us:   30_000_000,            // 30 s
                flow_bytes_s_milli: 700_000_000,           // 700 KB/s
                packet_count:       12_000,
        ...
        Scenario {
            ...
            telemetry: NetworkTelemetry {
                ...
                dst_port:           443,
                protocol:           6,
                flow_duration_us:   2_500_000,             // 2.5 s
                flow_bytes_s_milli: 15_000_000,            // 15 KB/s (normal HTTPS)
                packet_count:       42,
                direction:          0,
                sourcetype:         0,                     // simulated (sparse → cap)
            },
        },
        ...
        Scenario {
            ...
            telemetry: NetworkTelemetry {
                ...
                dst_port:           21,
                protocol:           6,
                flow_duration_us:   45_000_000,            // 45 s
                flow_bytes_s_milli: 6_200_000,             // 6.2 KB/s
                packet_count:       280,
                direction:          0,
                sourcetype:         1,
            },
